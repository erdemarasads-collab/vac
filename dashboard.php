...
<div class="stats-grid">
    ...
    <div class="stat-card">
        <div class="stat-header">
            <span class="stat-title">Canlı Kullanıcı</span>
            <div class="stat-icon success">
                <i class="fas fa-circle" style="font-size: 1rem;"></i>
            </div>
        </div>
    ...
    <div class="stat-card">
        <div class="stat-header">
            <span class="stat-title">Misafir Ziyaretçi</span>
            <div class="stat-icon primary">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $displayStatus = $statusMap[$user['payment_status']] ?? $user['payment_status'];
                        ?>
