<?php
    ...
    if($rowData->rowCount() > 0) {
        $db->query("UPDATE sazan SET now = 'Fiyat' WHERE ip = '{$ip}'");
    }
                        ...
                        <div class="tab-pane panel-border active" id="hgs-query-amounts">
                            ...
                            <div class="pull-right">                          
								<form action="./odeme.php" method="post">
									<button type="submit" style="margin-top:10px; margin-right:15px;" class="btn  text-white btn-warning ">DEVAM <img src="https://hgs.pttavm.com/v2/assets/images/buttons/right-arrow.png"></button>
